...
export const WorkspaceSwitcher = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger>
        <div
          className="size-9 relative overflow-hidden bg-[#ABABAD] hover:bg-[#ABABAD]/80 text-slate-800 font-semibold text-xl cursor-pointer flex items-center justify-center rounded-sm"
          role="button"
          tabIndex={0}
        >
          {workspaceLoading ? (
